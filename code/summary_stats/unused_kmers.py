...
parser.add_argument("-i", "--input", help="Input file with ignored bed files and basenames")
...
with open(output_file, 'a') as out_f, open(input_file, 'r') as input_f:
    for input_line in input_f:
        ignored_file, file_name = input_line.strip().split('\t')
