...
kmc -k${kmer_size} -cs4294967295 -fm -b -ci1 -t${threads} -m${mem} @${in_dir}/fasta_file_list.txt original_fasta_files ${in_dir}/kmc_temp >${in_dir}/source_kmer_counts.log
kmc_tools transform original_fasta_files dump -s ${output_file}
